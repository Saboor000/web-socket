    ...
    return (
        <div className="flex h-screen w-full bg-[#0f1115] overflow-hidden">
            ...
            <div className="flex flex-1 flex-col relative">
                {/* Header */}
                <header className="glass flex h-[73px] items-center justify-between px-8 border-b border-white/10 z-10">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-zinc-500">
                                {typingUser ? (
                                    <span className="text-blue-400 animate-pulse">{typingUser} is typing...</span>
                                ) : (
